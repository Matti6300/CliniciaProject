package com.android.hsm.androiddriverutility;
...
public class AndroidriverUtility {
   ...
   public void switchToContext(AndroidDriver driver, String Partitalcontext)
   {
	   Set<String> context = driver.getContextHandles();
		for(String co: context)
		{
			...
			{
				driver.context(Partitalcontext);
			}
